...
const Reservation = () => {
  ...
  return (
    <div className="bg-[url('/images/map.svg')] bg-center bg-no-repeat bg-bottom flex flex-col container mx-auto text-center justify-center items-center mt-20 p-4 w-screen ">
