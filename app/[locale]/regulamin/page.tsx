...
const About = () => {
  ...
  return (
    <div className="flex flex-col text-center justify-center items-center mt-10 px-4 py-16 w-screen">
      ...
      <div className="flex flex-col relative lg:flex-row lg:gap-8 container py-10 mt-10 px-6 text-left border-1 border-black after:content-[''] after:border-1 after:border-black after:w-full after:h-full after:absolute after:inset-x-2 after:-inset-y-2 lg:divide-x  lg:divide-black">
