...
export async function POST(req: Request) {
  ...
  const msgToPerson = {
    ...
    text: "Potwierdzenie wysłania wiadomości",
    attachments: [
      {
        filename: "logo.png",
    ...
    * {
    ...
    <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><span style="color: #e67e23; font-size: 26px; line-height: 36.4px; background-color: #ffffff;"> Twoja wiadomość została przesłana! </span></p>
      </div>
    ...
    <p style="font-size: 14px; line-height: 130%;"><span style="font-size: 16px; line-height: 20.8px; font-family: Lato, sans-serif;">Dziękujemy za wysłanie pytania! Odezwiemy się do Ciebie najszybciej jak tylko jest to możliwe. </span></p>
      </div>
    ...
    <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><strong>Numer telefonu: </strong> <span style="color: #828080; font-size: 14px; line-height: 19.6px;">${
          data.phone
        } .</span></p>
      </div>
    ...
    <table id="u_content_text_15" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; color: #333333; line-height: 160%; text-align: left; word-wrap: break-word;">
        <p style="line-height: 160%;"><span style="font-family: Lato, sans-serif; line-height: 22.4px;"><span style="font-size: 16px; line-height: 25.6px;">Podczas rozmowy telefonicznej lub w odpowiedzi na tę wiadomość nasz pracownik odpowie na wszystkie pytania oraz niejasności.</span></span></p>
      </div>
