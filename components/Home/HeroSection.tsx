...
const HeroSection = () => {
  ...
  return (
    <div className="section-container bg-gray-100 min-h-screen">
      <div className="container flex flex-col md:flex-row justify-center items-start mx-auto align-middle md:p-5">
        ...
        <aside className="max-w-[50vw] w-full md:w-6/12 md:flex hidden  justify-start">
          <Image src={"/images/droga.png"} alt="tak" width={800} height={400} />
        </aside>
      </div>
    </div>
  );
