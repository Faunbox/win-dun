...
const HomeBuses = () => {
  ...
  return (
    <section className="flex flex-col bg-white justify-center items-center py-4 mx-32">
      ...
      <div className="container text-center p-4 flex flex-col rounded-2xl border-1 border-black">
        <ul className="flex flex-col md:flex-row justify-around mt-8 gap-2 divide-x divide-black">
