...
const Why = () => {
  ...
  return (
    <section className="section-container">
      <div className="flex flex-col container mx-auto lg:py-12 md:my-20 md:p-4 justify-center items-center align-middle relative">
        <div className="flex flex-col lg:flex-row  items-center">
          <div className="hidden lg:block mx-auto p-4 md:p-0 lg:col-span-1 ">
            <Image
              ...
              width={1240}
              height={720}
              className="hover:scale-110 duration-700 lg:absolute lg:-top-24 lg:-left-[38%] xl:-left-[35%] 2xl:-left-[25%]"
            />
          </div>
