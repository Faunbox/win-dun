...
const Luggage = () => {
  ...
  return (
    <div className="container flex flex-col md:flex-row my-20">
      <div
        className="w-full h-full md:w-6/12 contrast-50 hover:contrast-100 duration-300 ease-in-out"
      >
        <Image
      ...
      <div className="w-full md:w-6/12  flex flex-col bg-gray-200">
        <div className="flex flex-col h-full items-center relative py-4">
          <h2 className="text-xl font-light">
            Jak przygotować paczkę do wysyłki ?
          </h2>
          <p className="absolute bottom-[40%]">
            Tekst o wielkości bagażu i wadze
          </p>
        </div>
        <div className="h-full bg-gray-300 flex items-center justify-center p-4">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia
            reiciendis a natus officia reprehenderit autem voluptas debitis.
            Dicta praesentium iste, obcaecati alias eaque debitis quam dolore,
            atque eveniet blanditiis beatae.
          </p>
        </div>
      </div>
    </div>
