              ...
              <div className="relative wrap overflow-hidden lg:p-10 h-full">
                ...
                <div className="mb-8 flex justify-between flex-row-reverse items-center pt-10 w-full left-timeline">
                  ...
                  <div className="order-1 w-5/12 px-4 py-4 text-right items-right relative">
                    ...
                    <h4 className="mb-3 font-bold text-lg lg:text-xl">
                      {t("steps.1.header")}
                    </h4>
                    <p className="text-sm lg:text-base leading-snug text-black text-opacity-100">
                      {t("steps.1.desc")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-start w-full right-timeline">
                  ...
                  <div className="order-1  w-5/12 px-1 py-4 relative">
                    ...
                    <h4 className="mb-3 font-bold  text-lg lg:text-xl text-left">
                      {t("steps.4.header")}
                    </h4>
                    <p className="text-sm lg:text-base leading-snug text-black text-opacity-100 text-left">
                      {t("steps.4.desc")}
                    </p>
                  </div>
                </div>
